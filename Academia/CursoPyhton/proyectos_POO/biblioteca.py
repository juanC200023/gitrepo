...
class Biblioteca:
    ...
    def agregar_libro(self, libro):
        if libro.id_libro not in self.libros:
            ...
            print(f"[!] No es posible agregar el libro con el ID {libro.id_libro}")
...
if __name__ == '__main__':
    ...
    libro1 = Libro(1, "Juan Castro", "Como ser un genio?")
    libro2 = Libro(2, "Pepito panol", "Aprende a dibujar")
