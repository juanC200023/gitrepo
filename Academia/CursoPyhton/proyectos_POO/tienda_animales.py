...
class Animal:
    ...
    def __str__(self):
        return f"{self.nombre} ({self.especie}) - {'Alimentado' if self.alimentado else 'Hambreiento'}"
...
if __name__ == '__main__':
    ...
    tienda = TiendaAnimales("Mi tenda de animales")
    ...
    print("\n[+] Mostrando los animales una vez Tijuana ha sido vendida:\n")
